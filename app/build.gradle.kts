...
dependencies {
    ...
    implementation("androidx.datastore:datastore-preferences:1.0.0")  //전 프로젝트에 있던 것
    ...
    testImplementation("io.mockk:mockk:1.13.0") //추가
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.6.0") //추가
